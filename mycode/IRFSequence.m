...
if SolveStickyPriceTransition
	...
	if ComputeDiscountedMPC; DiscountedMPCTransition; end
	stickytransition = false;
end

% irfsave => irfstruct(0)
% OutputDirIRF = trim(OutputDir) // "IRF_" // trim(IRFDir) // "/NOFS/"
% CALL SaveIRFOutput
% 
...
%         	irfpriceexp.cumSTICKY = CumulativePolicyType(ccum1,ccum2,ccum4,dcum1,dcum2,dcum4)
% 
...
%     	OutputDirIRF = trim(OutputDir) // "IRF_" // trim(IRFDir) // "/PE"// trim(lstring) // "/"        
%     	CALL SaveIRFOutput
%         
% 	END DO
%     
